...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'row style-three' ); ?>>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="post-thumbnail matchHeight">
			<img src="<?php echo esc_url( get_parent_theme_file_uri( '/assets/images/no-image/No-Image-Found-400x264.png' ) ); ?>" alt="<?php echo esc_attr__( 'No Image Found', 'uvo' ); ?>" width="400" height="264">
	...
	<?php } ?>
		<div class="entry-main matchHeight">
			...
			<div class="post-meta">
				<span class="date"><?php echo esc_html__( 'Published On', 'uvo' ); ?> <?php echo get_the_date(); ?></span>
				<?php if ( true == radiantthemes_global_var( 'display_categries', '', false ) ) : ?>
					<span class="category-list">
						<?php echo esc_html__( 'In', 'uvo' ); ?>
						<?php
			...
			<div class="entry-content">
				<p><?php echo wp_kses( substr( wp_strip_all_tags( get_the_excerpt() ), 0, 120 ), 'rt-content' ) . '...'; ?></p>
			</div><!-- .entry-content -->
			<span class="author">
				<?php echo esc_html__( 'By', 'uvo' ) . ' ' . get_the_author_link(); ?>
			</span>
		</div><!-- .entry-main -->
	</div>
</article><!-- #post-## -->
