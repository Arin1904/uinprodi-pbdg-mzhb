...
<div <?php post_class( 'radiantthemes-shop-box matchHeight style-eight' ); ?>>
	<div class="holder">
		<?php if ( $product->is_on_sale() ) { ?>
			<?php echo apply_filters( 'woocommerce_sale_flash', '<span class="onsale">' . esc_html__( 'Sale!', 'uvo' ) . '</span>', $post, $product ); ?>
		<?php } ?>
		<div class="pic">
