...
//			echo '<span class="screen-reader-text">Dismiss this notice.</span></button>';
		...
		echo '<span id="sync-msg-update-changes"><b>', __('You have unsaved changes. Syncing now will only update Content that is currently written to the database and not your unsaved changes.', 'wpsitesynccontent'), '</b></span>';
